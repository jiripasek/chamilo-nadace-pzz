 ...
 */
  //SG
 function api_send_mail($prijemce, $predmet, $obsah, $additional_headers = null, $additional_parameters = null) 
 {
 		//MAIL - POTVRZENI
		...
		return mail($prijemce, $predmet, $obsah, $headers);
	}
 //SG
function api_send_mailX($to, $subject, $message, $additional_headers = null, $additional_parameters = null) {
