...
FCKLang['BrowseServer']       = 'Foliumi en la Servilo' ;
FCKLang['Folder']             = 'Folder' ;
FCKLang['CreateNewFolder']    = 'Create a folder' ;
FCKLang['UploadFile']         = 'Upload a file' ;
FCKLang['Upload']             = 'Alŝuti' ;
FCKLang['UploadSelectFileFirst'] = 'Bonvolu unue elekti dosieron antaŭ alkalki alŝuton. ' ;

FCKLang['ResourceTypeRoot']   = 'Bazo' ;
FCKLang['ResourceTypeAudio']  = 'Audio' ;
FCKLang['ResourceTypeFlash']  = 'Flash' ;
FCKLang['ResourceTypeImages'] = 'Images' ;
FCKLang['ResourceTypeVideo']  = 'Vidbendo' ;
