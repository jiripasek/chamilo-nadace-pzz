 ...
 */
  //SG
  function api_mail($recipient_name, $prijemce, $predmet, $obsah, $sender_name, $email_admin)
	{
		//MAIL - POTVRZENI
 ...
 //SG
function api_mailX($recipient_name, $recipient_email, $subject, $message, $sender_name = '', $sender_email = '', $extra_headers = '') {
