...
if ($formSent && isset($_POST)) {
    ...
    if ($exerciseType == ALL_ON_ONE_PAGE || $questionNum >= $nbrQuestions) {        
        if (api_is_allowed_to_session_edit()) {
           ...
           //SG - pøidána druhá èást podmínky " || $objExercise->results_disabled" kvùli skrývání odpovìdí pokud se zobrazovat nemají!
            if ($exerciseType == ALL_ON_ONE_PAGE || $objExercise->results_disabled) {
