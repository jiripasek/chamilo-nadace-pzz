...
$HelpSharedFolder = "Tento adresář obsahuje soubory, které nahráli školitelé do kurzu zkrz editor. Ale zpravidla jsou viditelné jakýmkoli školitelem, ale jsou skryté pro ostatní studenty. Pokud uděláte adresář viditelný, ostatní uživatelé uvidí celý obsah";
$TemplateImage = "Ikona šablony";
$MoveElement = "Pohnout prvkem";//SGV
$CertificateName = "Jméno";//SGV
$CopyToMyFiles = "Zkopírovat do mých soukromých složek";//SGV
$Export2PDF = "Převést do PDF formátu";//SGV
$ResourceShared = "Sdílený zdroj";//SGV
$CopyAlreadyDone = "Už existuje soubor se stejným jménem na Vaší soukromé ploše. Chcete ho přepsat?";//SGV
$CopyFailed = "Kopírování se nezdařilo";//SGV
$CopyMade = "Kopírování dokončeno";//SGV
$OverwritenFile = "Soubor nahrazen";//SGV
$Draw = "Kreslit";//SGV
$FileExistsChangeToSave = "Tento název souboru již existuje, vyberte si jiný pro uložení Vašeho obrázku.";//SGV
$FileSavedAs = "Soubor uložen jako";//SGV
$FileExportAs = "Soubor odeslán jako";//SGV
$UserFolder = "Soubor uživatele";//SGV
$HelpUsersFolder = "INFORMACE VIDITELNÁ POUZE UČITELEM:<br /><br />
Tento soubor obsahuje různé zabezpečené šablony jež byly vytvořeny pro hodnotící nástroje. Není doporučeno vytvořit tento soubor viditelný všem."; //SGV
$HelpFolderChat = "INFORMACE ZPŘÍSTUPNĚNÁ POUZE UČITELI: 

Tento soubor obsahuje všechny schůzky jež byly otevřeny na chatu. Ačkoliv schůzky na chatu mohou být obyčejné, Jiné mohou být zajímavé a hodny zahrnutí jako přídatný pracovní dokument. Provádět toto beze změny zpřístupnění tohoto souboru, udělejte soubor přístupný a odkažte odkud usoudíte vhodnost. Nedoporučuje se vytvořit tento soubor přístupný všem."; //SGV
$HelpFolderCertificates = "INFORMATION VISIBLE TO THE TEACHER ONLY:<br /><br />
This folder contains the various certificates templates that have been created for the rating tool. It is not recommended to make this folder visible to all."; //TODO
$DestinationDirectory = "Cílový soubor";//SGV
$CreateAudio = "Vytvořit zvuk";//SGV
$InsertText2Audio = "Vložte text jež chcete přeměnit na zvukový soubor";//SGV
$HelpText2Audio = "Změnit Váš text na řeč";//SGV
$BuildMP3 = "Vytvořit mp3";//SGV
$Voice = "Hlas";//SGV
$Female = "Žena";//SGV
$Male = "Muž";//SGV
$GoogleAudio = "Použít Google zvukový servis";//SGV
$vozMe = "Použít vozMe zvukový servis";//SGV
$HelpGoogleAudio = "Podpora až 100 znaků v široké paletě jazyků. Soubory jsou vygenerovány a automaticky uloženy do Chamilo adresáře kde se právě nacházíte.";//SGV
$HelpvozMe = "Podpora textů o několika tisících znacích, můžete si také vybrat typ hlasu, mužský nebo ženský. Pracuje s méně jazyky, a zvuková kvalita je nižší. Nakonec,budete muset stáhnout soubory ručně z nového okna.";//SGV
$SaveMP3 = "Uložit mp3";//SGV
$Speed = "Rychlost";//SGV
$GoFaster = "Rychleji";//SGV
$Fast = "Rychle";//SGV
$Normal = "Normálně";//SGV
$Slow = "Pomalu";//SGV
$SlowDown = "Pomaleji";//SGV
$Pediaphon = "Použít Pediaphon zvukový servis";//SGV
$HelpPediaphon = "Podpora textu s něolika tisíci znaky, s různými typy mužských nebo ženských hlasů (v závislosti na jazyku). Zvukové soubory budou vygenerovány a automaticky uloženy do Chamilo adresáře ve kterém se právě nacházíte.";//SGV
$FirstSelectALanguage = "Prosím vyberte jazyk";//SGV
$RenameAndComment = "Přejmenovat a okomentovat";//SGV
$YouAreCurrentlyUsingXOfYourX = "Právě používáte %s MB (%s) z Vašich %s MB.";//SGV
$UplUploadFailedSizeIsZero = "Objevil se problém při nahrávání Vašeho dokumentu: přijatý soubor obsahoval 0 bytů velikosti na serveru. Prosím, přezkoumejte Vaše místní soubory pro jakoukoliv poruchu nebo zničení, pak zkuste znovu.";//SGV
$NewImage = "Nový obrázek";//SGV
$DirExists = "Operaci není možné provést, adresář tohoto jména již existuje.";//SGV
$DocMv = "Dokument přemístěn";//SGV
?>
