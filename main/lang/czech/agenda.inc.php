...
$RepeatDate = "Zopakovat data";//SGV
$EndDateMustBeMoreThanStartDate = "Konečné datum musí být později než počáteční datum";//SGV
$SelectACourse = "Výběr kurzu";//SGV
$PleaseSelectACourseOrASessionInTheLeftColumn = "Prosím vyberte si kurz nebo sezení v postranní liště.";//SGV
$DisableEndDate = "Nepoužitelné konečné datum";//SGV
$AllEvents = "Všechny události";//SGV
?>
