...
$AllowUserViewUserList = "Povolení uživateli prohlédnout uživatelský list";//SGV
$AllowUserViewUserListActivate = "Aktivovat uživatelský list";//SGV
$AllowUserViewUserListDeactivate = "Invalidní uživatelský list";//SGV
$DoNotDisplayAnyAdvance = "Nezobrazovat vývoj";//SGV
$NewHomeworkEmailAlert = "Uživatelé schránky na domácím vytváření";//SGV
$NewHomeworkEmailAlertEnable = "Aktivovat schránku uživatelů na domácí podání";//SGV
$NewHomeworkEmailAlertDisable = "Invalidní schránka uživatelů pro domácí podání";//SGV
$DisplayAboutNextAdvanceNotDoneAndLastDoneAdvance = "Zobrazit poslední vykonaný krok a další nedokončený krok";//SGV
$AddPicture = "Přidat obrázek";//SGV
$LPAutoLaunch = "Aktivovat výuku samospuštění";//SGV
$ConfigLearnpath = "Výuka cestou nastavení";//SGV
$PDFWaterMarkHeader = "Vodoznak hlavičky se exportuje v PDF";//SGV
$RedirectToALearningPath = "Přesměrování k výběru výukové cesty";//SGV
$RedirectToTheLearningPathList = "Přesměrování k seznamu výukových cest";//SGV
?>
