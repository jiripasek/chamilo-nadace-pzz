...
$SessionName = "Název sezení";//SG
$SessionCategory = "Kategorie sezení";//SG
$Expand = "Rozbalit";//SG
$Collapse = "Sbalit";//SG
$CourseDetails = "Popis kurzu";//SG
$GroupPendingInvitations = "Aktuální skupinové pozvánky";//SG
$Compose = "Napsat zprávu"; //SG
$ThereAreNoCoursesInThisCategory = "V této kategorii se nenalézá žádný kurz.";//SG
?>
